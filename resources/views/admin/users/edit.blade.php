...
<div class="card">
    ...
    <h4>
        {{ trans(tenant()->id.'/global.edit') }} {{ trans(tenant()->id.'/cruds.user.title_singular') }}
    </h4>
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" type="username" name="username" id="username" value="{{ old('username', $user->username) }}" required>
