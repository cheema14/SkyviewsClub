...
<div class="card">
    <div class="card-header">
        {{ trans(tenant()->id.'/global.edit') }} {{ trans(tenant()->id.'/cruds.dependent.title_singular') }}
    </div>
        ...
        <form method="POST" action="{{ route("admin.employee.dependents.update", [$employeedependent->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control  {{ $errors->has('relation') ? 'is-invalid' : '' }}" name="relation" id="relation">
                        ...
                        <option value="{{ $key }}" 
                        {{ old('relation', isset($employeedependent) ? $employeedependent->relation : '') == $key ? 'selected' : '' }}>
                        {{ $label }}
                    </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input maxlength="50" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $employeedependent->name) }}">
                    @if($errors->has('name'))
                        <div class="invalid-feedback">
                            {{ $errors->first('name') }}
                        </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control  {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $employeedependent->address) }}" maxlength="110">
                ...
                @if(
                    $employeedependent->relation == array_search('Husband', App\Models\EmployeeDependent::RELATION_SELECT) 
                    || 
                    $employeedependent->relation == array_search('Wife', App\Models\EmployeeDependent::RELATION_SELECT)
                    )
                    <div x-data class="form-group col-md-4 spouse_div">
                        <label class="" for="cnic">{{ trans(tenant()->id.'/cruds.employee.dependents.cnic') }}</label>
                        <input x-mask="99999-9999999-9" class="form-control  {{ $errors->has('cnic') ? 'is-invalid' : '' }}" type="text" name="cnic" id="cnic" value="{{ old('cnic', $employeedependent->cnic) }}">
                        @if($errors->has('cnic'))
                            <div class="invalid-feedback">
                                {{ $errors->first('cnic') }}
                            </div>
                    ...
                    <div x-data class="form-group col-md-4 spouse_div">
                        ...
                        <input x-mask="9999-9999999" class="form-control  {{ $errors->has('cell_no') ? 'is-invalid' : '' }}" type="text" name="cell_no" id="cell_no" value="{{ old('cell_no', $employeedependent->cell_no) }}">
                    ...
                    <div class="form-group col-md-4 spouse_div">
                        ...
                        <input  class="form-control marriage_date {{ $errors->has('marriage_date') ? 'is-invalid' : '' }}" type="text" name="marriage_date" id="marriage_date" value="{{ old('marriage_date',$employeedependent->marriage_date) }}">
                    ...
                    <div class="form-group col-md-4 spouse_div">
                        ...
                        <input class="form-control {{ $errors->has('marriage_place') ? 'is-invalid' : '' }}" type="text" marriage_place="marriage_place" id="marriage_place" value="{{ old('marriage_place', $employeedependent->marriage_place) }}">
                    ...
                    <div class="form-group col-md-4 spouse_div">
                        ...
                        <input class="form-control  {{ $errors->has('nationality') ? 'is-invalid' : '' }}" type="text" name="nationality" id="nationality" value="{{ old('nationality', $employeedependent->nationality) }}">
                    ...
                    <div class="form-group col-md-4 spouse_div">
                        ...
                        <select class="form-control  {{ $errors->has('religion') ? 'is-invalid' : '' }}" name="religion" id="religion">
                            ...
                            <option value="{{ $key }}" 
                            {{ old('religion', isset($employeedependent) ? $employeedependent->religion : '') == $key ? 'selected' : '' }}>
                            {{ $label }}
                        </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-4 spouse_div">
                        ...
                        <input class="form-control  {{ $errors->has('cast') ? 'is-invalid' : '' }}" type="text" name="cast" id="cast" value="{{ old('cast', $employeedependent->cast) }}">
                        @if($errors->has('cast'))
                            <div class="invalid-feedback">
                                {{ $errors->first('cast') }}
                            </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control  {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender">
                        ...
                        <option value="{{ $key }}" 
                        {{ old('relation', isset($employeedependent) ? $employeedependent->gender : '') == $key ? 'selected' : '' }}>
                        {{ $label }}
                    </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control  {{ $errors->has('profession') ? 'is-invalid' : '' }}" type="text" name="profession" id="profession" value="{{ old('profession', $employeedependent->profession) }}">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input  class="form-control birth_date {{ $errors->has('date_of_birth') ? 'is-invalid' : '' }}" type="text" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth',$employeedependent->date_of_birth) }}">
...
<script>
        ...
        var relation = "<?php echo $employeedependent->relation; ?>";
