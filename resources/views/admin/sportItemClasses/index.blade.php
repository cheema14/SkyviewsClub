    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.sport-item-classes.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.sportItemClass.title_singular') }}
            </a>
        </div>
    </div>
@endcan
...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.sportItemClass.title_singular') }} {{ trans('global.list') }}
    </div>
                        ...
                        <tr data-entry-id="{{ $sportItemClass->id }}">
                            ...
                            <td>
                                ...
                                @can('sport_item_class_delete')
                                    <form action="{{ route('admin.sport-item-classes.destroy', $sportItemClass->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
