...
<div class="card">
    <div class="card-header">
        <h4>
        {{ trans(tenant()->id.'/global.create') }} {{ trans(tenant()->id.'/cruds.member.title_singular') }}
        </h4>
    </div>
        ...
        <form method="POST" action="{{ route("admin.members.store") }}" enctype="multipart/form-data">
            ...
            <div class="card-body row">
                    ...
                    <div class="form-group col-md-4">
                        <label class="required">{{ trans(tenant()->id.'/cruds.member.fields.membership_status') }}</label>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <span class="help-block">{{ trans(tenant()->id.'/cruds.member.fields.lahorebase_helper') }}</span>
                            ...
                            <div x-data class="form-group col-md-4 monthly_subscription_revised_div" style="display: none">
                                ...
                                <input class="form-control absentee_from_date {{ $errors->has('absentee_from_date') ? 'is-invalid' : '' }}" type="text" name="absentee_from_date" id="edit_birth_date" value="">
                            ...
                            <div x-data class="form-group col-md-4 monthly_subscription_revised_div" style="display: none">
                                <label class="required" for="absentee_to_date">{{ trans(tenant()->id.'/cruds.member.fields.absentee_to_date') }}</label>
                                <input class="form-control absentee_to_date {{ $errors->has('absentee_to_date') ? 'is-invalid' : '' }}" type="text" name="absentee_to_date" id="edit_birth_date" value="">
                            ...
                            {{-- <div x-data class="form-group col-md-4 monthly_subscription_revised_div" style="display:none;">
                                ...
                                <input x-mask="99" placeholder="Enter Duration for discounted subscription amount" class="form-control {{ $errors->has('no_of_months') ? 'is-invalid' : '' }}" type="text" name="no_of_months" id="no_of_months" value="{{ old('no_of_months', '') }}">
                            ...
                            <div x-data class="form-group col-md-4" >
                                ...
                                <input x-mask="999" placeholder="Enter Membership Discount" class="form-control {{ $errors->has('discount_on_membership_fee') ? 'is-invalid' : '' }}" type="text" name="discount_on_membership_fee" id="discount_on_membership_fee" value="{{ old('discount_on_membership_fee', '') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="dep_gender[]" id="dep_gender" required>
                                            <option value disabled {{ old('dep_gender', null) === null ? 'selected' : '' }}>{{ trans(tenant()->id.'/global.pleaseSelect') }}</option>
                                            @foreach(App\Models\Member::GENDER_SELECT as $key => $label)
                                    ...
                                    <td>
                                        ...
                                        <!-- <div class="form-group col-md-12">
                                            <label for="photo">{{ trans(tenant()->id.'/cruds.member.fields.dep_photo') }}</label>
                                            ...
                                            @endif
                                            <span class="help-block">{{ trans(tenant()->id.'/cruds.member.fields.dep_photo_helper') }}</span>
                                        </div> -->
                                    </td>
...
<script>
    ...
    dictDefaultMessage: "Attach Member`s picture",
    maxFiles: 1,
    addRemoveLinks: true,
    headers: {
...
<script>
    Dropzone.options.signatureDropzone = {
        ...
        maxFiles: 1,
        addRemoveLinks: true,
        dictDefaultMessage: "Attach Member`s Signature",
        headers: {
        'X-CSRF-TOKEN': "{{ csrf_token() }}"
        },
        params: {
...
<script>
    ...
    Dropzone.options.frontDropzone = {
        ...
        maxFiles: 1,
        addRemoveLinks: true,
        dictDefaultMessage: "Attach CNIC`s front picture",
        headers: {
        'X-CSRF-TOKEN': "{{ csrf_token() }}"
        },
        params: {
    ...
    Dropzone.options.backDropzone = {
        ...
        maxFiles: 1,
        addRemoveLinks: true,
        dictDefaultMessage: "Attach CNIC`s back picture",
        headers: {
        'X-CSRF-TOKEN': "{{ csrf_token() }}"
        },
        params: {
