...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-memberOrders">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($orders as $key => $order)
                        <tr data-entry-id="{{ $order->id }}">
                            ...
                            <td>
                                {{ $order->member->membership_no ?? '' }}
                            </td>
                            <td>
                                {{ $order->member->cell_no ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-memberOrders:not(.ajaxTable)').DataTable({ buttons: dtButtons })
