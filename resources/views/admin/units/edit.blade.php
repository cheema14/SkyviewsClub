...
<div class="card">
    <div class="card-header">
        <h5>
        {{ trans(tenant()->id.'/global.edit') }} {{ trans(tenant()->id.'/cruds.unit.title_singular') }}
        </h5>
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.units.update", [$unit->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input maxlength="30" class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $unit->type) }}" required>
                @if($errors->has('type'))
