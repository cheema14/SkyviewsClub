...
<div class="card">
    <div class="card-header">
        <h4>
        {{ trans(tenant()->id.'/global.edit') }} {{ trans(tenant()->id.'/cruds.employee.title_singular') }}
        </h4>
    </div>
    ...
    <form method="POST" action="{{ route("admin.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
        ...
        <div class="card-body row">
            ...
            <div x-data class="form-group col-md-4">
                <label for="phone">{{ trans(tenant()->id.'/cruds.employee.fields.phone') }}</label>
                <input x-mask="9999-9999999" class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $employee->phone) }}">
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div x-data class="form-group col-md-4">
                ...
                <input x-mask="9999-9999999" class="form-control {{ $errors->has('cell_number') ? 'is-invalid' : '' }}" type="text" name="cell_number" id="cell_number" value="{{ old('cell_number', $employee->cell_number) }}">
            ...
            <div class="form-group col-md-4">
                <label for="designation">{{ trans(tenant()->id.'/cruds.employee.fields.designation') }}</label>
            ...
            <div class="form-group col-md-4">
                ...
                <select class="form-control {{ $errors->has('salary_mode') ? 'is-invalid' : '' }}" name="salary_mode" id="salary_mode">
                    ...
                    @foreach(App\Models\Employee::SALARY_MODE as $key => $label)
                        <option value="{{ $key }}" {{ old('salary_mode', $employee->salary_mode) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('bank_name') ? 'is-invalid' : '' }}" type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $employee->bank_name) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('bank_account_no') ? 'is-invalid' : '' }}" type="text" name="bank_account_no" id="bank_account_no" value="{{ old('bank_account_no', $employee->bank_account_no) }}">
