    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.menus.create') }}">
                {{ trans(tenant()->id.'/global.add') }} {{ trans(tenant()->id.'/cruds.menu.title_singular') }}
            </a>
        </div>
    </div>
@endcan -->
...
<div class="card">
    <div class="card-header">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4>
                    {{ trans(tenant()->id.'/cruds.menu.title_singular') }} {{ trans(tenant()->id.'/global.list') }}
                </h4>
            </div>
            @can('menu_create')
            <div class="col-sm-6 ml-auto text-sm-right">
                <a class="btn btn-info px-4" href="{{ route('admin.menus.create') }}">
                {{ trans(tenant()->id.'/global.add') }} {{ trans(tenant()->id.'/cruds.menu.title_singular') }}
                </a>
            </div>
            @endcan
    ...
    <div class="card-body">
        <table class=" table table-borderless table-striped table-hover ajaxTable datatable datatable-Menu">
            <thead>
                <tr>
                    {{-- <th width="10">
