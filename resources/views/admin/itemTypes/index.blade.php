    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.item-types.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.itemType.title_singular') }}
            </a>
            @can('csv_import')
...
<div class="card">
    <div class="card-header">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4>
                {{ trans('cruds.itemType.title_singular') }} {{ trans('global.list') }}
                </h4>
            </div>
            @can('item_type_create')
                        ...
                        <tr data-entry-id="{{ $itemType->id }}">
                            ...
                            <td class="text-center">
                                ...
                                @can('item_type_delete')
                                    <form action="{{ route('admin.item-types.destroy', $itemType->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
